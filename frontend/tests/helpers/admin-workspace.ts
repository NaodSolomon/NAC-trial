...
// Extracted from the visual suite so the accessibility suite can render the same
// populated administrator workspace instead of maintaining a second set of mocks.
...
export const adminWorkspaceScreens = [
...
export async function mockAdminWorkspace(context: BrowserContext, page: Page) {
